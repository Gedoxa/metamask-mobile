...
export const BLOCKAID_SUPPORTED_NETWORK_NAMES = {
  [NETWORKS_CHAIN_ID_DECIMAL_STRING.MAINNET]: 'Ethereum Mainnet',
  [NETWORKS_CHAIN_ID_DECIMAL_STRING.BSC]: 'Binance Smart Chain',
  [NETWORKS_CHAIN_ID_DECIMAL_STRING.OPTIMISM]: 'Optimism',
  [NETWORKS_CHAIN_ID_DECIMAL_STRING.POLYGON]: 'Polygon',
  [NETWORKS_CHAIN_ID_DECIMAL_STRING.ARBITRUM]: 'Arbitrum',
  [NETWORKS_CHAIN_ID_DECIMAL_STRING.LINEA_MAINNET]: 'Linea',
};
